        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div class="md:col-span-2">
                ...
                <select name="status_type" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-primary-500" id="statusType">
                    ...
                    <option value="wirausaha" {{ old('status_type') == 'wirausaha' ? 'selected' : '' }}>Wirausaha</option>
                    <option value="mengurus keluarga" {{ old('status_type') == 'mengurus keluarga' ? 'selected' : '' }}>Mengurus Keluarga</option>
                </select>
                @error('status_type')
                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <div id="bekerjaFields" class="hidden md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="bekerja_status_nama" value="{{ old('bekerja_status_nama') }}" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-primary-500">
                ...
                <div>
                    ...
                    <select name="bekerja_jenis_pekerjaan" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-primary-500">
                        <option value="Guru PNS" {{ old('bekerja_jenis_pekerjaan') == "Guru PNS" ? 'selected' : '' }}>Guru PNS</option>
                        <option value="Guru Non PNS" {{ old('bekerja_jenis_pekerjaan') == "Guru Non PNS" ? 'selected' : '' }}>Guru Non PNS</option>
                        <option value="Tentor/Instruktur/Pengajar" {{ old('bekerja_jenis_pekerjaan') == "Tentor/Instruktur/Pengajar" ? 'selected' : '' }}>Tentor/Instruktur/Pengajar</option>
                        <option value="Pengelola Kursus" {{ old('bekerja_jenis_pekerjaan') == "Pengelola Kursus" ? 'selected' : '' }}>Pengelola Kursus</option>
                        <option value="Bisnis/Berjualan" {{ old('bekerja_jenis_pekerjaan') == "Bisnis/Berjualan" ? 'selected' : '' }}>Bisnis/Berjualan</option>
                        <option value="Karyawan Swasta" {{ old('bekerja_jenis_pekerjaan') == "Karyawan Swasta" ? 'selected' : '' }}>Karyawan Swasta</option>
                        <option value="Tidak" {{ old('bekerja_jenis_pekerjaan') == "Tidak" ? 'selected' : '' }}>Tidak</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="bekerja_tahun_mulai" value="{{ old('bekerja_tahun_mulai') }}" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-primary-500" min="1900" max="{{ date('Y') }}">
            ...
            <div id="kuliahFields" class="hidden md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="kuliah_status_nama" value="{{ old('kuliah_status_nama') }}" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-primary-500">
                ...
                <div>
                    <label class="block text-gray-300 mb-1">Tahun Mulai</label>
                    <input type="number" name="kuliah_tahun_mulai" value="{{ old('kuliah_tahun_mulai') }}" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-primary-500" min="1900" max="{{ date('Y') }}">
            ...
            <div id="wirausahaFields" class="hidden md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="wirausaha_status_nama" value="{{ old('wirausaha_status_nama') }}" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-primary-500">
                ...
                <div>
                    <label class="block text-gray-300 mb-1">Jenis Pekerjaan</label>
                    <input type="text" name="wirausaha_jenis_pekerjaan" value="{{ old('wirausaha_jenis_pekerjaan') }}" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-primary-500">
                ...
                <div>
                    <label class="block text-gray-300 mb-1">Tahun Mulai</label>
                    <input type="number" name="wirausaha_tahun_mulai" value="{{ old('wirausaha_tahun_mulai') }}" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-primary-500" min="1900" max="{{ date('Y') }}">
